    ...
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          ...
          authorRole: typeof post.authorRole === "string" ? post.authorRole : "",
          publishedDate: typeof post.publishedDate === "string" ? new Date(post.publishedDate).toISOString().split("T")[0] : new Date().toISOString().split("T")[0],
