      ...
      await createAuditLog(
        {
          ...
          action: "reorder",
          resource: "FooterSection",
          before: existingSections.map((s) => ({ id: s.id, order: s.order })) as Record<string, unknown>,
          after: sections as Record<string, unknown>,
          ipAddress: getClientIp(request),
          userAgent: getUserAgent(request),
        },
        request
      ...
      await createAuditLog(
        {
          ...
          action: "reorder",
          resource: "FooterLink",
          before: existingLinks.map((l) => ({ id: l.id, order: l.order })) as Record<string, unknown>,
          after: links as Record<string, unknown>,
          ipAddress: getClientIp(request),
          userAgent: getUserAgent(request),
        },
        request
