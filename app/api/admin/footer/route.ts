      ...
      await createAuditLog(
        {
          ...
          action: "reorder",
          resource: "FooterSection",
          before: JSON.stringify(existingSections.map((s) => ({ id: s.id, order: s.order }))),
          after: JSON.stringify(sections),
          ipAddress: getClientIp(request),
          userAgent: getUserAgent(request),
        },
        request
      ...
      await createAuditLog(
        {
          ...
          action: "reorder",
          resource: "FooterLink",
          before: JSON.stringify(existingLinks.map((l) => ({ id: l.id, order: l.order }))),
          after: JSON.stringify(links),
          ipAddress: getClientIp(request),
          userAgent: getUserAgent(request),
        },
        request
